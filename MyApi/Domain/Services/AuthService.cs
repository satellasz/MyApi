...
namespace MyApi.Domain.Services
{
    public class AuthService
    {
        ...
        {
            List<ApplicationUser> listUsers = await _userRepository.GetAll();
        ...
        {
            ApplicationUser findUser = await _userRepository.GetById(user.Id);
            if (findUser == null)
            ...
            return await _userRepository.Update(findUser);
        }

        public async Task DeleteUser(string userId)
        {
            ApplicationUser findUser = await _userRepository.GetById(userId);
            if (findUser == null)
                throw new ArgumentException("Usuário não encontrado");
